...
namespace CarpenterBll . Dao
{
    public class PowerDao
    {
        ...
        public DataTable GetPerson ( )
        {
            ...
            strSql . Append ( "SELECT DBA001,DBA002 FROM TPADBA WHERE DBA001!='DS'" );
        ...
        {
            StringBuilder strSql = new StringBuilder ( );
            strSql . Append ( "SELECT DISTINCT A.idx,A.POW002,B.DBA001,A.POW003,FOR001,B.DBA002,POW004,POW005,POW006,POW007,POW008,POW009,POW010,POW011,POW012,POW013,POW016,POW017   FROM MOXPOW A LEFT JOIN TPADBA B ON A.POW002=B.DBA001 LEFT JOIN MOXFOR C ON A.POW003=C.FOR002 " );

...
namespace CarpenterBll
{
    public static class LogHelperToSql
    {
        ...
        public static void SaveLog ( string cmdText ,string parameters )
        {
            ...
            strSql . AppendFormat ( "'{0}','{1}',GETDATE(),'{2}','{3}','{4}') " ,UserInformation . ProgramName ,UserInformation . UserNum ,cmdText . Replace ( "'" ,"''" ) ,parameters ,UserInformation . TypeOfOper );
        ...
        public static void SaveLog ( string cmdText ,params SqlParameter [ ] parameters )
        {
            ...
            strSql . Append ( "LOG001,LOG002,LOG003,LOG004,LOG005,LOG006) " );
            strSql . Append ( "VALUES (" );
            strSql . AppendFormat ( "'{0}','{1}',GETDATE(),'{2}','{3}','{4}') " ,UserInformation . ProgramName ,UserInformation . UserNum ,cmdText . Replace ( "'" ,"''" ) ,param ,UserInformation . TypeOfOper );
